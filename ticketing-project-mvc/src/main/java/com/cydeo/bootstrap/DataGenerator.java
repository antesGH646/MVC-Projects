...
public class DataGenerator implements CommandLineRunner {
   ...
   TaskService taskService;
    ...
    public void run(String... args) throws Exception {
        ...
        //create different role objects
        RoleDTO adminRole = new RoleDTO(1L,"Admin");
        RoleDTO managerRole = new RoleDTO(2L,"Manager");
        RoleDTO employeeRole = new RoleDTO(3L,"Employee");

        //add the role type into the map object using the save() method
        ...
        //adding users into the map object using save method
        ...
        ProjectDTO project3 = new ProjectDTO("Spring Container","PR003",user1,
                LocalDate.now(),LocalDate.now().plusDays(32),"Creating Container", Status.IN_PROGRESS);

        //adding projects into the map object using save method
